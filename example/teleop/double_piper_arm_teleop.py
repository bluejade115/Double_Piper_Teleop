...
if __name__ == "__main__":
    cfg = tyro.cli(DoublePiperTeleopConfig)
    import os
    ...
    for i in range(num_episode):
        ...
        master = MasterWorker("master_arm", start_event, end_event,config=cfg)
        slave = SlaveWorker("slave_arm", start_event, end_event, master.data_buffer,config=cfg)
